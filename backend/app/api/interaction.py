...
from ..models import User, Video, Like, Favorite, Comment
...
@router.post("/like", response_model=LikeResponse, summary="点赞/取消点赞视频")
...
@router.post("/favorite", response_model=FavoriteResponse, summary="收藏/取消收藏视频")
...
@router.post("/comment", response_model=CommentResponse, summary="发表评论")
...
@router.get("/video/{video_id}/comments", response_model=CommentsResponse, summary="获取视频评论列表")
async def get_video_comments(
    ...
    for comment in top_comments:
        comment_responses.append(build_comment_tree(comment))
